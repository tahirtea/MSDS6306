...
setwd("C:/Users/18880/MSDS6306")


load(paste(getwd(),"/HW4/fivethirtyeight/data/college_recent_grads.rda",sep="",collapse = NULL))
...
barplot(major_count$Frequency, names.arg = major_count$Major, xlab = "Major", ylab = "Frequency", main = "Frequency of Major", horiz=TRUE, col="blue")
```

d. Write the fivethirtyeight data to a csv file. Make sure it does not have row labels.
```{r write_csv}
write.csv(x=df, file=paste(getwd(),"/HW4/college_recent_grads.csv",sep="",collapse = NULL), row.names = FALSE)
```
